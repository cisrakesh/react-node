export const ENGLISH = {
    ...
    /* Bad Dealers */
    LABEL_REPORTED_DATE_TIME: 'Reported date-time',
    LABEL_REMARK: 'Remark',
    LABEL_USER_NAME: 'User Name',
    LABEL_DEALER_NAME: 'Dealer Name',
    ...
    /* Notices */
    LABEL_WRITTEN_DATE: 'Written Date',
    LABEL_PUSH_MESSAGE: 'Push Message',
    LABEL_ADD_NOTICES: 'Add Notices',
    LABEL_EDIT_NOTICES: 'Edit Notices',
    ...
    MENU_BAD_DEALERS_MGT: 'Bad Dealers Management',
    MENU_TERM_POLICY_MGT: 'Term & Policy Management',
    MENU_NOTICE_MGT: 'Notice Management',
    MENU_DISPLAY_ADV_MGT: 'Advertisement Management',
    MENU_NOTIFICATION_MGT: 'Notification Management',
    MENU_REPERSENT_NUMBER_MGT: 'Representative Management',
