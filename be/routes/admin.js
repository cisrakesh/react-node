...
module.exports = (router,preFix) => {
    ...
    router.route(preFix+'/get-driver-list')
        .post([validateAdminToken], ReportController.getDriverList);

    router.route(preFix+'/get-activated-user')
        .post([validateAdminToken], ReportController.getActivatedUser);

    router.route(preFix+'/update-setting')
        .put([validateAdminToken], SettingController.updateGeneralSetting);

    router.route(preFix+'/pending-usercount')
        .post([validateAdminToken], SettingController.getPendingCounts);

    router.route('/admin/dummy-file-upload')
        .put(upload.any(), ReportController.dummyFileUpload);
